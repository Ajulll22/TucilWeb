...
<section id="abouts" class="abouts">
    ...
    <div class="container">
        ...
        <a href="<?php echo base_url('product/create'); ?>" class="btn btn-success float-left mb-3">Tambah Produk</a>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
						...
						<td><img src="<?php echo base_url('upload/product/'.$data['product_img']) ?>" width="64" /></td>
