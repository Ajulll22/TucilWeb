...
<head>
    ...
    <link rel="stylesheet" href="https://raw.githubusercontent.com/Ajulll22/CSS/main/style.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo base_url('product/update/'.$product['product_id']); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="product_price" value="<?php echo $product['product_price']; ?>" class="form-control" placeholder="Harga Produk">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="file" name="product_img" value="<?php echo $product['product_img']; ?>" class="form-control" >
            </div>
            <div class="form-group">
